<header>
	...
	<a href="{{ url('/admin/dashboard') }}" class="logo">
		<h2 class="text-white p-3" style="margin-top: 13px">Zohairs Motors</h2>
	</a>
	<!-- Logo ends -->
	...
	<ul id="header-actions" class="clearfix">
		<li class="list-box hidden-xs dropdown">
			...
			<ul class="dropdown-menu imp-notify">
				...
				<li>
					<div class="icon">
						<img src="{{ asset('back_end/img/thumbs/user10.png') }}" alt="Arise Admin">
					</div>
					<div class="details">
				...
				<li>
					<div class="icon">
						<img src="{{ asset('back_end/img/thumbs/user6.png') }}" alt="Arise Admin">
					</div>
					<div class="details">
				...
				<li>
					<div class="icon">
						<img src="{{ asset('back_end/img/thumbs/user1.png') }}" alt="Arise Admin">
					</div>
					<div class="details">
		...
		<li class="list-box user-admin hidden-xs dropdown">
			<div class="admin-details">
				<div class="name" style="font-size: 18px;">{{ $users->name }}</div>
